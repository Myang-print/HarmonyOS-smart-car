...
黑胶带循迹、岔路选择、死胡同回退和终点停车的后续开发统一采用GPIO11→PA10的6字节双轮速度协议：方向0为正转、1为反转，速度范围0~250；STM32超过2秒未收到合法帧会停车。完整接口、调用关系、安全约束和开发前验收项见 [PROTOCOL.md](PROTOCOL.md)。当前Iter0已确认赛道为黑胶带走线、两侧白胶带围边；起点和终点各自都是完整“干”字型标记，纵向黑线连续通过两条横线，中间存在白色间隔。本次赛道固定策略为：第一个Y字岔路选择左侧，第二个Y字岔路选择右侧；该策略仅适用于本次赛道。
