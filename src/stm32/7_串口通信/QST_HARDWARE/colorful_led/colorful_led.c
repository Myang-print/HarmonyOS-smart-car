...
static void LED_Set_Solid(u8 red, u8 green, u8 blue) {
  u8 i;

  for (i = 1; i <= led_num; i++) {
    L_ws2812_rgb(i, red, green, blue);
    R_ws2812_rgb(i, red, green, blue);
  }
  LED_Show_Frame();
}
...
void LED_State_Forward_Step(void) {
  LED_Set_Solid(0, 96, 0);
}

void LED_State_Reverse_Step(void) {
  LED_Set_Solid(96, 0, 0);
}

void LED_State_Left_Step(void) {
  LED_Set_Solid(0, 0, 96);
}

void LED_State_Right_Step(void) {
  LED_Set_Solid(96, 48, 0);
}

void LED_Diagnostic_Boot_Step(void) {
  LED_Set_Solid(64, 64, 64);
}

void LED_Diagnostic_Waiting_Step(void) {
  static u8 tick = 0;

  if (tick < 4)
    LED_Set_Solid(0, 0, 32);
  else
    LED_All_Off_Step();
...
void LED_Diagnostic_Activity_Step(void) {
  LED_Set_Solid(96, 72, 0);
}

void LED_Diagnostic_InvalidFrame_Step(void) {
  LED_Set_Solid(96, 0, 96);
}

void LED_Diagnostic_Timeout_Step(void) {
  static u8 tick = 0;
...
void LED_Diagnostic_Stop_Step(void) {
  LED_Set_Solid(48, 48, 48);
}
