...
/* Hi3861 协议速度为 rad/s 的 100 倍；2π 放大 1000 倍用于整数换算。 */
#define CAR_PROTOCOL_SPEED_SCALE       ((s32)100)
#define CAR_TWO_PI_MILLI               ((s32)6283)
#define CAR_PROTOCOL_MAX_SPEED_X100    ((s16)250)
#define CAR_REMOTE_SPEED_GAIN_NUM      ((s32)5)
#define CAR_REMOTE_SPEED_GAIN_DEN      ((s32)2)
#define CAR_REMOTE_COMMAND_TIMEOUT_MS  ((u16)2000)
...
/* Hi3861 连续遥控接口：每 50ms 调用一次 Control_RemoteStep。 */
